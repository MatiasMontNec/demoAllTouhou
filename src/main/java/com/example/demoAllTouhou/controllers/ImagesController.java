...
import com.example.demoAllTouhou.dtos.ImagesDTO;
import com.example.demoAllTouhou.dtos.ImagesListDTO;
...
//    }
//
//    // **Obtener imágenes por merchId**
//    @GetMapping("/by-merch/{merchId}")
//    public ResponseEntity<ImagesListDTO> getImagesBymerchId(@PathVariable Long merchId) {
//        List<ImagesEntity> entities = imagesService.getImagesBymerchId(merchId);
//        List<ImagesDTO> dtos = entities.stream().map(this::mapToDTO).collect(Collectors.toList());
//        return ResponseEntity.ok(new ImagesListDTO(dtos));
//    }
//
...
//        entity.setmerchId(dto.getmerchId());
//        return entity;
//    }
//
